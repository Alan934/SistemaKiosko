...
namespace StockKiosko
{
    public partial class frmReporteTotal : Form
    {
        ...
        private void btnBuscarReporte_Click(object sender, EventArgs e)
        {
            ...
            lista = new CNReporte().ReporteTotal(txtFechaInicio.Value.ToString("dd/MM/yyyy"), txtFechaFin.Value.ToString("dd/MM/yyyy"));
        ...
        private void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    saveFile.FileName = string.Format("ReporteGeneral_{0}.xlsx", DateTime.Now.ToString("ddMMyyyyHHmmss"));
